...
const navItems: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Package,
    items: [
      { label: 'Grupos', icon: FolderTree, href: '/material/group' },
  ...
  },
  {
    ...
    icon: Warehouse,
    items: [
      { label: 'Localizações', icon: MapPin, href: '/addressing/location' },
      {
        label: 'Sub-localizações',
        icon: BookMarked,
        href: '/addressing/sub-location',
      },
      { label: 'Fileiras', icon: Rows3, href: '/addressing/row' },
      { label: 'Prateleiras', icon: Layers, href: '/addressing/shelf' },
      { label: 'Posições', icon: Columns3, href: '/addressing/position' },
      { label: 'Endereços', icon: Warehouse, href: '/addressing/addressing' },
    ],
  },
  {
    title: 'Movimentação',
