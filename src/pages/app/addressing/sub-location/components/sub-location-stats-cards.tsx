...
interface SubLocationStatsCardsProps {
  totalItems?: number;
  totalActive?: number;
...
export function SubLocationStatsCards({
  totalItems = 0,
  totalActive = 0,
  totalInactive = 0,
  itemCount = 0,
  lastCreated,
}: SubLocationStatsCardsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      {/* Total de Sub-Localizações */}
      <Card>
