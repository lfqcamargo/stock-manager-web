import { Calendar, CheckCircle, Rows, TrendingUp, XCircle } from 'lucide-react';

import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { formatDate, formatRelativeTime } from '@/utils/format-date';

interface RowStatsCardsProps {
  totalItems?: number;
  totalActive?: number;
...
export function RowStatsCards({
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center space-y-2">
            <Rows className="h-8 w-8 text-primary mx-auto" />
      ...
      {/* Distribuição por Sub-Localização */}
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">
            Distribuição por Sub-Localização
        ...
        <CardContent>
          <div className="text-center space-y-2">
            <Rows className="h-8 w-8 text-blue-600 mx-auto" />
